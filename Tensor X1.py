...
# Specify the latitude and longitude for filtering
latitude_filter = 49.915021
longitude_filter = -6.3170727


# Read the data and filter for the specific latitude and longitude
df = spark.sql(
"""
    SELECT 
        latitude,
        ...
        count_date,
        hour
    FROM guh_2024.default.traffic_counts_filtered
    WHERE latitude = {latitude_filter} AND longitude = {longitude_filter}
""")
